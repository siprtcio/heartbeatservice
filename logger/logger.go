...
func InitLogger() {
	var err error
	logger, err = NewLogger(beego.AppConfig.String("logging_level"),
		beego.AppConfig.String("logging_facility"),
		beego.AppConfig.String("logging_tag"),
		beego.AppConfig.String("logging_format"),
		beego.AppConfig.String("logging_sentry"),
		beego.AppConfig.String("logging_syslog"))
	...
	contextLogger = logger.WithFields(logrus.Fields{
		"version": "1.0",
		"host":    hostname,
		"tag":     beego.AppConfig.String("logging_tag"),
	})
...
func Panic(msg string, fields LogFields) {
	contextLogger.WithFields(logrus.Fields(fields)).WithFields(filefuncName()).Panic(msg)
}

func Fatal(msg string, fields map[string]interface{}) {
	contextLogger.WithFields(logrus.Fields(fields)).WithFields(filefuncName()).Fatal(msg)
}

func Error(msg string, fields map[string]interface{}) {
	contextLogger.WithFields(logrus.Fields(fields)).WithFields(filefuncName()).Error(msg)
}

func Warn(msg string, fields map[string]interface{}) {
	contextLogger.WithFields(logrus.Fields(fields)).WithFields(filefuncName()).Warn(msg)
}

func Info(msg string, fields map[string]interface{}) {
	contextLogger.WithFields(logrus.Fields(fields)).WithFields(filefuncName()).Info(msg)
}

func Debug(msg string, fields map[string]interface{}) {
	contextLogger.WithFields(logrus.Fields(fields)).WithFields(filefuncName()).Debug(msg)
}

func Trace(msg string, fields map[string]interface{}) {
	contextLogger.WithFields(logrus.Fields(fields)).WithFields(filefuncName()).Trace(msg)
}
